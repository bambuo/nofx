...
export const coinSource = {
  ...
  ai500: { zh: '综合评分榜', en: 'Score Top', es: 'Ranking de Puntuacion' },
  ...
  useAI500: { zh: '启用综合评分榜', en: 'Enable Score Top', es: 'Habilitar Ranking de Puntuacion' },
  ai500Limit: { zh: '数量上限', en: 'Limit', es: 'Límite' },
  useOITop: { zh: '启用 OI 持仓增加', en: 'Enable OI Increase', es: 'Habilitar Aumento OI' },
  oiTopLimit: { zh: '数量上限', en: 'Limit', es: 'Límite' },
  useOILow: { zh: '启用 OI 持仓减少', en: 'Enable OI Decrease', es: 'Habilitar Disminución OI' },
  ...
  providerTitle: { zh: '数据提供方', en: 'Data Providers', es: 'Proveedores de Datos' },
  providerDesc: { zh: '按顺序尝试，未返回数据时自动使用下一个', en: 'Tried in order; falls back when a provider returns no data', es: 'Se prueban en orden; usa el siguiente si no hay datos' },
  nofxosProvider: { zh: 'NofxOS', en: 'NofxOS', es: 'NofxOS' },
  nofxosProviderDesc: { zh: '需配置自有 NofxOS Key', en: 'Requires your own NofxOS key', es: 'Requiere tu propia clave NofxOS' },
  binanceProvider: { zh: 'Binance', en: 'Binance', es: 'Binance' },
  binanceProviderDesc: { zh: '公开合约行情与 OI 历史', en: 'Public futures tickers and OI history', es: 'Tickers futures publicos e historial OI' },
  ...
  providerNote: { zh: '按上方数据提供方顺序获取候选币种', en: 'Candidate coins are fetched using the provider order above', es: 'Las monedas candidatas se obtienen segun el orden de proveedores anterior' },
};
